...
public class AuCalcolaIndicatoriDaoImpl implements AuCalcolaIndicatoriDao {
	...
	public void getDatiCampagnaVarCompDto(long idCampagna,
		...
		String queryStr = "SELECT "
				...
				+ " 		AU_M_NONCONF mnc2 "
				+ " 	WHERE "
				+ " 		snc2.ID_S_SESSIONE = ausess2.ID_S_SESSIONE "
				...
				+ " 		au_campagna cam "
				+ " 	WHERE "
				+ " 		snc.ID_S_SESSIONE = ausess.ID_S_SESSIONE "
				+ " 		AND snc.ID_S_NONCONF = svc1.ID_S_NONCONF "
				+ " 		AND ausess.ID_SESSIONE = sess.ID_SESSIONE "
				+ " 		AND svc1.ID_M_NONCONF = mnc.ID_M_NON_CONF "
				+ " 		AND mvc.ID_M_NONCONF = mnc.ID_M_NON_CONF "
