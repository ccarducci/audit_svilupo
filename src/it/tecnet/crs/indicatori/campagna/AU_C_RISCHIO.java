...
public class AU_C_RISCHIO {
	...
	@Id
	@SequenceGenerator(name = "ID_AU_C_RISCHIO_SEQ_GENERATOR", sequenceName = "ID_AU_C_RISCHIO_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ID_AU_C_RISCHIO_SEQ_GENERATOR")
	private Long id;
